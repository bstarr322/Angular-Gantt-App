...
gantt._render_grid_header_resize = function () {
	...
	for (var i = 0; i < columns.length; i++) {
		...
		if (col.resize) {
			...
			this._waiAria.gridSeparatorAttr(resize_el);

			this.$grid_scale.appendChild(resize_el);
			resize_el.style.left = Math.max(0, width - 1) + "px";
		}
	}
	...
	if (this.config.grid_resize) {
		...
		this._waiAria.gridSeparatorAttr(grid_resize_el);

		this.$grid_scale.appendChild(grid_resize_el);
		grid_resize_el.style.left = Math.max(0, this.config.grid_width - 1) + "px";
	}
};
...
gantt._grid_resize = {
	...
	container_before_start: gantt.bind(function (grid_dnd, obj, e) {
	...
	contianer_after_start: gantt.bind(function (grid_dnd, obj, e) {
	...
	container_drag_move: gantt.bind(function (grid_dnd, obj, e) {
	...
	container_drag_end: gantt.bind(function (grid_dnd, obj, e) {
...
gantt._init_resize = function () {
	...
	if (gantt.defined(this.config.dnd_sensitivity))
		dnd.config.sensitivity = this.config.dnd_sensitivity;

	dnd.attachEvent("onBeforeDragStart", function(obj, e){return gantt._grid_resize.column_before_start(dnd, obj, e);});
	dnd.attachEvent("onAfterDragStart", function(obj, e){return gantt._grid_resize.column_after_start(dnd, obj, e);});
	dnd.attachEvent("onDragMove",function(obj, e){return gantt._grid_resize.column_drag_move(dnd, obj, e);});
	dnd.attachEvent("onDragEnd", function(obj, e){return gantt._grid_resize.column_drag_end(dnd, obj, e);});
	...
	grid_dnd.attachEvent("onBeforeDragStart", function(obj, e){return gantt._grid_resize.container_before_start(grid_dnd, obj, e);});
	grid_dnd.attachEvent("onAfterDragStart", function(obj, e){return gantt._grid_resize.contianer_after_start(grid_dnd, obj, e);});
	grid_dnd.attachEvent("onDragMove", function(obj, e){return gantt._grid_resize.container_drag_move(grid_dnd, obj, e);});
	grid_dnd.attachEvent("onDragEnd", function(obj, e){return gantt._grid_resize.container_drag_end(grid_dnd, obj, e);});
};
...
gantt.attachEvent("onBeforeSmartRender", activate);
		...
		if (typeof(config) === 'string') {
			...
			this.each(function() {
				if (this && this.getAttribute){
					if (!this.gantt && !(window.gantt._obj == this)){
